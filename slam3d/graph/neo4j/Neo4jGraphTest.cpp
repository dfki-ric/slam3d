...
#include <slam3d/measurements/redis/RedisMeasurements.hpp>
...
void initDB() {
    ...
    if (!initialized) {
        std::shared_ptr<slam3d::Measurements> measurements = std::make_shared<slam3d::RedisMeasurements>("localhost", 6379);
